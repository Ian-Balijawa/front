...
const OrderList = () => {
    ...
    const data = [
        {
            supplier: 'Nico&Nic Suppliers',
            order_in_progress_by: 'deusgrace@goldpos.com',
            order_started_on: '21/07/2022 12:00',
        },
        {
            supplier: 'Nico&Nic Suppliers',
            order_in_progress_by: 'deusgrace@goldpos.com',
                            ...
                            <Row>
                                <Col
                                    ...
                                    style={{
                                        background: '#fff',
                                        boxShadow:
                                            '0px 6px 15px 3px rgba(84, 84, 84, 0.1)',
                                    }}
                                >
                                    <GPCustomTable
                                        data={data}
                                ...
                                <Col lg="6" md="6">
                                    ...
                                    >
                                        Select an order on the left to view its
                                        content
                                    </div>
                                </Col>
                            </Row>
